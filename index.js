window.addEventListener('DOMContentLoaded',function(event){
    ...
    form_register.addEventListener('submit',function(event){
        ...
        if(input_name.value == ""){
            document.querySelector('#name_container .input-error').innerHTML ='El Nombre es obligario';
            canSubmit = false;
        }else{
            if(input_name.value.length<5){
                document.querySelector('#name_container .input-error').innerHTML ='El nombre debe tener almenos 5 caracteres';
                canSubmit=false;
            }else{
        ...
        if(input_last_name.value.length<4){
            document.querySelector('#last_name_container .input-error').innerHTML ='El apellido debe tener 4 caracteres'
            canSubmit=false;
        }else{
        ...
        if(input_user_name.value ==""){
            document.querySelector('#user_name_container .input-error').innerHTML='El nomber de usuario es obligatorio';
            canSubmit =false;
        }else{
        ...
        if(input_email.value ==""){
            document.querySelector('#email_container .input-error').innerHTML='El correo esta mal';
            canSubmit =false;
        }else{
